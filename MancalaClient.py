...
## While loop runs with an or (instead of and) because there is a break in winner, so it runs until reaching the break
while (gameboard.checks_winner(player1)) or (gameboard.checks_winner(player2)):
    ## Checks if the player1 holes still have seeds by calling checking winner,
    ## else it prints that the second player won and breaks
    if gameboard.checks_winner(player1):
        ...
        break
    ## Checks if the player2 holes still have seeds by calling checking winner,
    ## else it prints that the first player won and breaks
